        ...
        if self.observations:
            ...
            if 'enfermedad actual:' in obs:
                ...
                if len(parts) > 1:
                    ...
                    content = parts[1]
                    for delimiter in ['examen físico general:', 'examen físico:', 'examen por sistemas:', 'examen regional:', 'exámenes auxiliares:', 'diagnóstico:', 'tratamiento:', 'recomendaciones:', 'observaciones adicionales:', '---fin enfermedad actual---']:
            ...
            for marker in ['examen físico general:', 'examen físico:']:
                if marker in obs:
                    ...
                    if len(parts) > 1:
                        ...
                        for delimiter in ['examen por sistemas:', 'examen regional:', 'exámenes auxiliares:', 'diagnóstico:', 'tratamiento:', 'recomendaciones:', 'observaciones adicionales:', '---fin examen físico general---']:
                            if delimiter in content:
                                content = content.split(delimiter)[0]
                                break
                        return content.strip()
        ...
        if self.observations:
            ...
            if 'examen por sistemas:' in obs:
                ...
                if len(parts) > 1:
                    content = parts[1]
                    # Múltiples delimitadores de fin
                    for delimiter in ['examen regional:', 'exámenes auxiliares:', 'diagnóstico:', 'tratamiento:', 'recomendaciones:', 'observaciones adicionales:', '---fin examen por sistemas---']:
                        if delimiter in content:
                            content = content.split(delimiter)[0]
                            break
                    return content.strip()
        ...
        if self.observations:
            ...
            if 'examen regional:' in obs:
                ...
                if len(parts) > 1:
                    content = parts[1]
                    # Múltiples delimitadores de fin
                    for delimiter in ['exámenes auxiliares:', 'diagnóstico:', 'tratamiento:', 'recomendaciones:', 'observaciones adicionales:', '---fin examen regional---']:
                        if delimiter in content:
                            content = content.split(delimiter)[0]
                            break
                    return content.strip()
        ...
        if self.observations:
            ...
            if 'exámenes auxiliares:' in obs:
                ...
                if len(parts) > 1:
                    content = parts[1]
                    # Múltiples delimitadores de fin
                    for delimiter in ['diagnóstico:', 'tratamiento:', 'recomendaciones:', 'observaciones adicionales:', '---fin exámenes auxiliares---']:
                        if delimiter in content:
                            content = content.split(delimiter)[0]
                            break
                    return content.strip()
